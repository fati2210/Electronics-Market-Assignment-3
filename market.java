...
public class market {
    ...
    private static final String password = "222023";
    ...
    public static void show_phones() throws Exception{
        ...
        String q="";
        switch (c){
            case 1:  q = "select * from phones where brand='Apple'";break;
    ...
    public static void show_tablets() throws Exception{
        Connection connection = DriverManager.getConnection(url,username,password);
        String q = "select * from tablets";
        Statement stmt = connection.createStatement();
        ResultSet res = stmt.executeQuery(q);
        while (res.next()){
            System.out.println("ID: "+res.getInt("id")+" Type: "+res.getString("type")+" Price: "+res.getInt("price"));
        }
        connection.close();
    }
    public static void show_accessories() throws Exception{
        ...
        do {
            ...
            switch (c){
                case 1:
                    String charger = "select * from charger";
                    Statement stmt = connection.createStatement();
                    ResultSet res = stmt.executeQuery(charger);
                    while (res.next()){
                        System.out.println("ID: "+res.getInt("id")+" Type: "+res.getString("type")+" Length: "+res.getDouble("length")+ " Price: "+res.getInt("price"));
                    }
                    break;
                case 2:
                    ...
                    while(res1.next()){
                        System.out.println("ID: "+res1.getInt("id")+" Volume: "+res1.getInt("volume")+" Price: "+res1.getInt("price"));
                    }
                    break;
                default:break;
            }
    ...
    public static void purchase() throws Exception{
        ...
        switch (cat){
            ...
            case 2:
                show_tablets();
                String q3="select price from tablets where id =?";
            ...
            case 3:
                ...
                while (result.next()){
                    System.out.println("ID: "+result.getInt("id")+" Type: "+result.getString("type")+" Length: "+result.getInt("length")+ " Price: "+result.getInt("price"));
                }

                String q6="select price from charger where id =?";
            ...
            case 4:
                ...
                String qu="select price from charger where id =?";
